<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editar-video.aspx.cs" Inherits="ProjetoFinalPAP.editar_video" %>
...
<head>
    ...
    <title>Skill Xec - Editar Vídeo</title>
...
<body>
        ...
        <div class="container">
            ...
            <main class="main-content">
                <section class="upload-form">
                    ...
                    <div class="form-group">
                        <label for="videoThumbnail">Alterar Thumbnail</label>
                    ...
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="videoCategory" runat="server" CssClass="dropdown">
                            ...
                            <asp:ListItem Text="Gameplay" Value="gameplay" />
                    ...
                    <div class="form-group">
                        <asp:Button ID="btnSubmit" runat="server" CssClass="submit-btn" Text="Salvar Alterações" OnClick="btnSubmit_Click" />
                        <asp:Button ID="btnDelete" runat="server" CssClass="delete-btn" Text="Apagar Vídeo" OnClientClick="return confirmDelete();" OnClick="btnDelete_Click" />
                    </div>
                </section>
            </main>
        </div>
    ...
    function confirmDelete() {
        return confirm("Tem a certeza que quer apagar este vídeo?");
    }
